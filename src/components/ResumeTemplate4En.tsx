      ...
      {filteredExperiences.length > 0 ? (
          ...
          {filteredExperiences.map((exp, idx) => (
            <div key={idx} className="relative pl-5 border-l-2 border-gray-200">
              <div className="absolute -left-1.5 top-0 w-3 h-3 rounded-full" style={{ backgroundColor: resumeData.colorHex || "#000000" }}></div>
...
const ResumeTemplate4En = React.memo(function ResumeTemplate4En({
  resumeData,
  className,
}: ResumePreviewProps) {
        ...
        >
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                <div className="text-center px-8">
                  ...
                  {resumeData.jobTitle && (
                    <h2 className="text-xl font-medium opacity-95">{resumeData.jobTitle}</h2>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-6">
              ...
              {/* Right Column - Summary and Work Experience */}
                ...
                <div className="w-2/3 space-y-6 pt-20">
                  <section>
                    ...
                    {secondPageWorkExperiences.length > 0 ? (
                      ...
                      <p className="text-sm text-gray-500 italic">No additional work experience</p>
                    )}
                  </section>
                </div>
              </div>
...
ResumeTemplate4En.displayName = 'ResumeTemplate4En';

export default ResumeTemplate4En;
