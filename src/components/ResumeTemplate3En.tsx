    ...
    >
      ...
      <style>{`
        ...
        @media print {
          ...
          [data-template="template3en"], [data-template="template3en"] * {
...
const ContactSection = React.memo(function ContactSection({ resumeData }: ResumeSectionProps) {
  return (
    <section className="mb-6">
      <h2 className="text-xl font-semibold mb-3 text-white" style={{ color: 'white' }}>Contact</h2>
      <div className="contact-info text-white space-y-2">
        {resumeData.phone && (
          <p className="flex items-center text-sm" style={{ color: 'white' }}>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2 text-white" viewBox="0 0 20 20" fill="currentColor" style={{ color: 'white' }}>
        ...
        <ul className="mt-2 text-gray-700 space-y-1 text-sm">
          {experience.description.split('\n').filter(Boolean).map((line, index) => (
            <li key={index} className="flex items-start">
              <span className="mr-2 text-black" style={{ color: colorHex }}>
                {getBulletContent()}
              </span>
              {line.trim()}
            </li>
...
const EducationSection = React.memo(function EducationSection({ resumeData }: ResumeSectionProps) {
  ...
  return (
    <section className="mt-8">
      <h2 className="text-xl font-semibold mb-3 text-white" style={{ color: 'white' }}>Education</h2>
...
const SkillsSection = React.memo(function SkillsSection({ resumeData }: ResumeSectionProps) {
  ...
  return (
    <section className="mt-8 mb-6">
      <h2 className="text-xl font-semibold mb-3 text-white" style={{ color: 'white' }}>Skills</h2>
        ...
        <ul className="list-disc-custom space-y-1">
          {skills.map((skill, index) => (
            <li key={index} className="flex items-start" style={{ color: 'white' }}>
              <span className="mr-2 text-white" style={{ color: 'white' }}>•</span>
              {skill}
            </li>
          ))}
        </ul>
...
const LanguagesSection = React.memo(function LanguagesSection({ resumeData }: ResumeSectionProps) {
  ...
  return (
    <section>
      <h2 className="text-xl font-semibold mb-3 text-white" style={{ color: 'white' }}>Languages</h2>
