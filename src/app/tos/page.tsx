...
export default function Page() {
  return (
    <main className="mx-auto max-w-prose space-y-6 p-3 py-6">
      ...
      <p>
        Welcome to ISera. These Terms of Service (&quot;Terms&quot;)
        govern your use of our website and services, including any paid
        subscription plans. By accessing or using ISera (&quot;the
        Service&quot;), you agree to be bound by these Terms. If you do not
        agree to these Terms, do not use the Service.
      </p>
      <h2 className="text-xl font-semibold">1. Overview</h2>
      <p>
        ISera is a SaaS platform that provides resume-building tools
      ...
      <ul className="list-inside list-disc">
        ...
        <li>
          <strong>Refund Policy:</strong> ISera does not offer
      ...
      <p>
        ISera grants you a limited, non-exclusive, non-transferable,
      ...
      <p>
        All content, trademarks, logos, and intellectual property related to ISera
        are owned by ISera or its licensors. You
        agree not to infringe on these rights.
      </p>
      <h2 className="text-xl font-semibold">10. User Content</h2>
      <p>
        By using the Service, you grant ISera a non-exclusive,
      ...
      <p>
        ...
        services (e.g., Stripe for payments). ISera is not
      ...
      <p>
        ...
        available&quot; basis. ISera makes no warranties, express or
      ...
      <p>
        To the fullest extent permitted by law, ISera shall not be
      ...
      <p>
        By using ISera, you acknowledge that you have read,
